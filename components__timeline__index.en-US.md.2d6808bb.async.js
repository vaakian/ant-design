"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[6812],{206783:function(m,i,t){t.r(i);var c=t(502143),p=t(968521),v=t(659378),h=t(28840),s=t(374912),o=t(828089),a=t(902068),x=t(574399),Z=t(863942),g=t(316073),C=t(24628),E=t(719260),f=t(956140),T=t(127179),d=t(905388),P=t(147341),O=t(606965),M=t(249706),b=t(795127),D=t(116846),W=t(73024),l=t(606641),r=t(667294),e=t(370917);function _(){var u=(0,l.eL)(),n=u.texts;return(0,e.tZ)(l.dY,null,(0,e.tZ)(r.Fragment,null,(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)("p",null,n[0].value),(0,e.tZ)("h2",{id:"when-to-use"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,e.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,e.tZ)("ul",null,(0,e.tZ)("li",null,n[1].value),(0,e.tZ)("li",null,n[2].value))),(0,e.tZ)(a.Z,{message:"After version 5.2.0, we provide a simpler usage <Timeline items={[...]} /> with better performance and potential of writing simpler code style in your applications. Meanwhile, we deprecated the old usage in browser console, we will remove it in antd 6.0."}),(0,e.tZ)("div",{className:"markdown"},(0,e.tZ)(s.Z,{lang:"jsx"},n[3].value),(0,e.tZ)("h2",{id:"examples"},(0,e.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,e.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,e.tZ)(d.Z,{items:[{demo:{id:"components-timeline-demo-basic"},previewerProps:{title:"Basic",filename:"components/timeline/demo/basic.tsx",jsx:`import { Timeline } from 'antd';
const App = () => (
  <Timeline
    items={[
      {
