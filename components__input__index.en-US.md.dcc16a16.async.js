...
export default App;
`,description:"<p>Using pre &#x26; post tabs example.</p>"}},{demo:{id:"components-input-demo-compact-style"},previewerProps:{title:"Compact Style",filename:"components/input/demo/compact-style.tsx",jsx:`import { Button, Input, Select, Space } from 'antd';
const { Search } = Input;
const options = [
  {
    value: 'zhejiang',
...
export default App;
`,description:'<p>Use <code>Space.Compact</code> create compact style, See the <a href="/components/space#spacecompact">Space.Compact</a> documentation for more.</p>'}},{demo:{id:"components-input-demo-group"},previewerProps:{debug:!0,title:"Input Group",filename:"components/input/demo/group.tsx",jsx:`import { CopyOutlined } from '@ant-design/icons';
import {
  AutoComplete,
  Button,
  Cascader,
