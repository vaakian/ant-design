"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[878],{552546:function(m,a,t){t.r(a);var c=t(502143),p=t(968521),Z=t(659378),v=t(28840),s=t(374912),l=t(828089),u=t(902068),h=t(574399),x=t(863942),f=t(316073),g=t(24628),b=t(719260),M=t(956140),E=t(127179),i=t(905388),P=t(147341),C=t(606965),y=t(249706),D=t(795127),O=t(116846),U=t(73024),o=t(606641),d=t(667294),n=t(370917);function r(){var _=(0,o.eL)(),e=_.texts;return(0,n.tZ)(o.dY,null,(0,n.tZ)(d.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("h3",{id:"usage-upgrade-after-510"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#usage-upgrade-after-510"},(0,n.tZ)("span",{className:"icon icon-link"})),"Usage upgrade after 5.1.0")),(0,n.tZ)(u.Z,{message:"After version 5.1.0, we provide a simpler usage <Mentions options={[...]} />  with better performance and potential of writing simpler code style in your applications. Meanwhile, we deprecated the old usage in browser console, we will remove it in antd 6.0."}),(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)(s.Z,{lang:"jsx"},e[2].value),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(i.Z,{items:[{demo:{id:"components-mentions-demo-basic"},previewerProps:{title:"Basic",filename:"components/mentions/demo/basic.tsx",jsx:`import { Mentions } from 'antd';
...
`,description:"<p>async.</p>",style:`.antd-demo-dynamic-option img {
  ...
  height: 20px;
  margin-right: 8px;
}`}},{demo:{id:"components-mentions-demo-form"},previewerProps:{title:"With Form",filename:"components/mentions/demo/form.tsx",jsx:`import { Button, Form, Mentions, Space } from 'antd';
...
export default App;
`,description:"<p>Configure <code>disabled</code> and <code>readOnly</code>.</p>"}},{demo:{id:"components-mentions-demo-placement"},previewerProps:{title:"Placement",filename:"components/mentions/demo/placement.tsx",jsx:`import { Mentions } from 'antd';
const App = () => (
  <Mentions
    style={{
      width: '100%',
