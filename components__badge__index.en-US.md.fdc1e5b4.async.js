...
export default App;
`,description:"<p>Use ribbon badge.</p>"}},{demo:{id:"components-badge-demo-ribbon-debug"},previewerProps:{debug:!0,title:"Ribbon Debug",filename:"components/badge/demo/ribbon-debug.tsx",jsx:`import { Badge, Card, Space } from 'antd';
const App = () => (
  <Space
    direction="vertical"
    style={{
...
export default App;
`,description:"<p>Using <code>count/dot</code> with custom <code>status/color</code>.</p>"}},{demo:{id:"components-badge-demo-title"},previewerProps:{debug:!0,title:"Title",filename:"components/badge/demo/title.tsx",jsx:`import { Avatar, Badge, Space } from 'antd';
const App = () => (
  <Space size="large">
