...
export default App;
`,description:"<p>Debug usage. Do not use in your production.</p>"}},{demo:{id:"components-select-demo-option-label-center"},previewerProps:{debug:!0,title:"Options label Centered",filename:"components/select/demo/option-label-center.tsx",jsx:`import { Select, Space, Typography } from 'antd';
const App = () => (
  <Space wrap>
    <Select
