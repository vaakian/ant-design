"use strict";(self.webpackChunkantd=self.webpackChunkantd||[]).push([[3880],{620761:function(_,a,t){t.r(a);var c=t(502143),m=t(968521),v=t(659378),p=t(28840),o=t(374912),s=t(828089),h=t(902068),Z=t(574399),x=t(863942),g=t(316073),C=t(24628),D=t(719260),y=t(956140),P=t(127179),d=t(905388),E=t(147341),f=t(606965),M=t(249706),O=t(795127),T=t(116846),R=t(73024),l=t(606641),u=t(667294),n=t(370917);function r(){var i=(0,l.eL)(),e=i.texts;return(0,n.tZ)(l.dY,null,(0,n.tZ)(u.Fragment,null,(0,n.tZ)("div",{className:"markdown"},(0,n.tZ)("p",null,e[0].value),(0,n.tZ)("h2",{id:"when-to-use"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#when-to-use"},(0,n.tZ)("span",{className:"icon icon-link"})),"When To Use"),(0,n.tZ)("p",null,e[1].value),(0,n.tZ)("h2",{id:"examples"},(0,n.tZ)("a",{"aria-hidden":"true",tabIndex:"-1",href:"#examples"},(0,n.tZ)("span",{className:"icon icon-link"})),"Examples")),(0,n.tZ)(d.Z,{items:[{demo:{id:"components-calendar-demo-basic"},previewerProps:{clientonly:!0,title:"Basic",filename:"components/calendar/demo/basic.tsx",jsx:`import { Calendar } from 'antd';
const App = () => {
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-notice-calendar"},previewerProps:{clientonly:!0,title:"Notice Calendar",filename:"components/calendar/demo/notice-calendar.tsx",jsx:`import { Badge, Calendar } from 'antd';
...
.notes-month section {
  font-size: 28px;
}`}},{demo:{id:"components-calendar-demo-card"},previewerProps:{clientonly:!0,title:"Card",filename:"components/calendar/demo/card.tsx",jsx:`import { Calendar, theme } from 'antd';
const onPanelChange = (value, mode) => {
  console.log(value.format('YYYY-MM-DD'), mode);
};
const App = () => {
...
export default App;
`,description:"<p>Nested inside a container element for rendering in limited space.</p>"}},{demo:{id:"components-calendar-demo-select"},previewerProps:{clientonly:!0,title:"Selectable Calendar",filename:"components/calendar/demo/select.tsx",jsx:`import { Alert, Calendar } from 'antd';
...
export default App;
`,description:"<p>A basic calendar component with Year/Month switch.</p>"}},{demo:{id:"components-calendar-demo-customize-header"},previewerProps:{clientonly:!0,title:"Customize Header",filename:"components/calendar/demo/customize-header.tsx",jsx:`import { Calendar, Col, Radio, Row, Select, Typography, theme } from 'antd';
import dayjs from 'dayjs';
